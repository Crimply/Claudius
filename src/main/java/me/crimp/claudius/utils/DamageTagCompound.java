...
public class DamageTagCompound extends NBTTagCompound {
    ...
    public DamageTagCompound(boolean empty, int true_damage) {
        this.empty = empty;
        this.true_damage = true_damage;
    }

    public DamageTagCompound(NBTTagCompound old, int true_damage) {
        super();
    ...
    public NBTTagCompound copy() {
        NBTTagCompound copy = new DamageTagCompound(this.empty, this.true_damage);

        for (String s : this.getKeySet()) {
            ((DamageTagCompound)copy).setTagLegacy(s, this.getTag(s).copy());
        }
