...
public class Surround
    ...
    private final me.crimp.claudius.utils.Timer timer = new me.crimp.claudius.utils.Timer();
    private final me.crimp.claudius.utils.Timer retryTimer = new Timer();
    ...
    public void onEnable() {
        ...
        if (this.center.getValue().booleanValue()) {
            Claudius.positionManager.setPositionPacket((double) this.startPos.getX() + 0.5, this.startPos.getY(), (double) this.startPos.getZ() + 0.5, true, true, true);
        }
        this.retries.clear();
        ...
        for (Vec3d vec3d : vec3ds) {
            ...
            switch (BlockUtil.isPositionPlaceable(position, false)) {
                case 1: {
                    ...
                    if (Claudius.speedManager.getSpeedKpH() != 0.0 || isExtending || this.extenders >= 1) continue block5;
